...
MODELS_SEED = [
    # Social Sweep
    {"task_type": "social_extraction", "model_name": "gemini-3.8-flash", "provider": "google", "is_active": 1, "is_fallback": 0},
    {"task_type": "social_extraction", "model_name": "gpt-4o-mini", "provider": "openai", "is_active": 0, "is_fallback": 1},
    
    # Tech Sweep
    {"task_type": "tech_extraction", "model_name": "gemini-3.8-flash", "provider": "google", "is_active": 1, "is_fallback": 0},
    {"task_type": "tech_extraction", "model_name": "gpt-4o-mini", "provider": "openai", "is_active": 0, "is_fallback": 1},
    
    # Jobs Sweep
    {"task_type": "jobs_extraction", "model_name": "gemini-3.8-flash", "provider": "google", "is_active": 1, "is_fallback": 0},
